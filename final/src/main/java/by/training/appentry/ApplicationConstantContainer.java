...
public class ApplicationConstantContainer {
    ...
    public static final String PASSWORD_CONFIRMATION_ERROR = "password-confirmation-error";
    public static final String PASSWORD_CONFIRMATION_ERROR_MESSAGE = "Passwords do not match, please, try again.";
    ...
    public static final String PLAYERS_NUMBER = "players-number";
    public static final String REGISTERED_MESSAGE = "Now you can log in with your username and password.";
