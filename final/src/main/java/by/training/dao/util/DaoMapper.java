...
import static by.training.dao.util.DaoMapper.Column.*;
...
public class DaoMapper {
    ...
    public static UserDto mapUserDto(ResultSet rs) throws SQLException {
        ...
        Wallet.Currency currency = Wallet.Currency.fromString(sCurrency).orElse(ValuesContainer.DEFAULT_CURRENCY);
