...
<div class="container">
    <div class="row">
        ...
        <div class="main-holder container">
            ...
            <form id="upload"
                  action="${pageContext.request.contextPath}${PathsContainer.COMMAND_UPDATE_ORGANIZER}${organizer.id}"
                  method="POST"
                  enctype='multipart/form-data'
            >
                <div class="col-sm-8" style="margin-top: 30px">
                    <div class="row" style="margin: 10px">
                        <h2 class="col-sm-12" style="margin-left: 0;">${organizer.name}&nbsp<fmt:message
                                key="editing"/></h2>
                    </div>
                        ...
                        <div class="col-sm-7" style="padding: 0; float: right;">
                            <div>
                                ...
                                <c:if test="${tournaments.size() == 0}">
                                    <a href="${pageContext.request.contextPath}${PathsContainer.COMMAND_DELETE_ORGANIZER}${organizer.id}">
