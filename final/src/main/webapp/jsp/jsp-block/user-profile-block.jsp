                ...
                <div class="profile-info col-sm-6">
                    <div class="row">
                        <div>
                            ...
                            <form id="user-form"
                                  name="user-form"
                                  action="${pageContext.request.contextPath}/?command=update_username"
                                  method="POST">
                                <input id="username"
                                       name="username"
                        ...
                        <div>
                            ...
                            <form action="${pageContext.request.contextPath}/?command=update_email" method="POST">
                            ...
                            <div class="dropdown col-sm-1">
                                <div class="update-button" style="float: left; padding: 15px">
                                    ...
                                    <div class="dropdown-content">
                                        <a href="${pageContext.request.contextPath}/?command=change_user_language_to_en">EN</a>
                                        <a href="${pageContext.request.contextPath}/?command=change_user_language_to_ru">RU</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <a href="${pageContext.request.contextPath}/?command=show_player&id=${user.playerAccountId}">
                        ...
                        <div>
                            <a href="${pageContext.request.contextPath}/?command=show_organizer&id=${user.organizerId}">
                                <div class="profile-info-link col-sm-12">
