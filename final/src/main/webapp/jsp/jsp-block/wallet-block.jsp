        ...
        <div class="center-block">
            ...
            <div>
                <form class="input-form" action="${pageContext.request.contextPath}${PathsContainer.COMMAND_DEPOSIT}"
                      method="post">
                    <input type="number" step="0.1" placeholder="<fmt:message key="value.to.deposit"/>" name="deposit"/>
            ...
            <div>
                <form class="input-form" action="${pageContext.request.contextPath}${PathsContainer.COMMAND_WITHDRAW}"
                      method="post">
                    <input type="number" step="0.1" placeholder="<fmt:message key="value.to.withdraw"/>"
                           name="withdraw"/>
