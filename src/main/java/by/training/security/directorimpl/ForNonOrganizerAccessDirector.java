...
public class ForNonOrganizerAccessDirector extends BaseSecurityDirector {
    ...
    private static final String REDIRECT_USER_TO = PathsContainer.COMMAND_SHOW_ORGANIZER;
    private static final String REDIRECT_NON_USER_TO = PathsContainer.FILE_LOGIN;
    private static final String MESSAGE_FOR_USER_KEY = AttributesContainer.ORGANIZER_EXISTS.toString();
